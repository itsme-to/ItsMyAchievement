...
class ResetCommand(plugin: ItsMyAchievement): Subcommand(
    plugin,
    "reset",
    "itsmyachievement.reset.achievement",
    false
) {
    override fun onExecute(sender: CommandSender, args: MutableList<String>) {
        ...
        player.resetAchievement(achievement)

        sender.sendMessage(plugin.langYml.getFormattedString("messages.prefix") +
                plugin.langYml.getString("messages.achievement-reset")
